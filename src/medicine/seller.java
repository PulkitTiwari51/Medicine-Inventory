...
class Seller {
    ...
    Seller(String t1) {
        ...
        add.addActionListener(e -> {
            String medname = JOptionPane.showInputDialog(frame, "ENTER MEDICINE NAME", "MEDICINE",
                    JOptionPane.QUESTION_MESSAGE);

            if (medname != null && !medname.isEmpty()) {
                if (medname.matches("[a-zA-Z ]+")) {
                    String quant = JOptionPane.showInputDialog(frame, "ENTER QUANTITY (10000 - 20000)", "QUANTITY",
                            JOptionPane.QUESTION_MESSAGE);
