...
class Customer {
                    ...
                    try {
                        ...
                        if (userQty <= availableQty && userQty > 0) {
                            ...
                            try (Connection con = DriverManager.getConnection(
                                    "jdbc:mysql://localhost:3306/medicine_inventory", "root", "Pulkit@2005")) {
                                ...
                                try (PreparedStatement updateStmt = con.prepareStatement(updateStockQuery)) {
                                    ...
                                    if (updated > 0) {
                                        ...
                                        JOptionPane.showMessageDialog(frame,
                                                "Order confirmed for " + selectedMed + " (Qty: " + userQty + ")");
                            ...
                            JOptionPane.showMessageDialog(frame,
                                    "Only " + availableQty + " available. Please enter a valid quantity.");
                        }
    ...
    void loadMedicines() {
        try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/medicine_inventory", "root",
                "Pulkit@2005")) {
